...
同样的代码，区别只有 是否`resp.Body.Close()` 是否被调用，我们运行一段时间后，发现内存差距如此之大

![](http://note-1253518569.cossh.myqcloud.com/20190712195959.png)
...
![](http://note-1253518569.cossh.myqcloud.com/20190717221524.png)
